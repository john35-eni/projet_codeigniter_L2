...
<head>
    ...
    <!---logo floreal--->
      <!--<div class="col-lg-6 d-none d-lg-block "><img src="<?php echo base_url();?>assets/img/floreal2.png"> </div>-->
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - register -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url();?>Admin/tableUser">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Voulez deconecter</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">Selectionner "Logout" si vous voulez quitter.</div>
