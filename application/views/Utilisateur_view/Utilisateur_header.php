    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index">
                ...
                <div class="sidebar-brand-text mx-3">Grand magasin</div>
            </a>
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url();?>Utilisateur/index">
           ...
           <!-- Nav Item - Tables -->
           <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url();?>Utilisateur/tables">
                    <i class="fas fa-fw fa-table"></i>
                    <span><b>Stock</b></span></a>
            </li>
            <!-- Divider -->
            <hr class="sidebar-divider d-none d-md-block">
             <!-- Nav Item - Historique -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url();?>Utilisateur/historique">
                    <i class="fas fa-fw fa-table"></i>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"> <b>Do you want disconnected?</b></h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body"><center>Select"<i> <b>Logout</b></i> "if you want disconnected.</center></div>
