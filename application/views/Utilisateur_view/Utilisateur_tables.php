                ...
                <div class="container-fluid">
                  ...
                  <!--  <h1 class="h3 mb-2 text-gray-800 text-center">Arrivages des fils</h1>-->
                    ...
                    <div class="row">    
                    <div class="col-md-4 ">
                            <button type="button" class="btn btn-outline-info mb-2" id="ajouterbtn">
                            <i class="fas fa-plus"></i><b> ADDS </b>
                            </button> 
                    </div>
                    <div class="col-md-offset-12"> 
                            <button class="btn btn-warning pull-rigth mb-2" id="total_stock">Total stock :  </button> 
                           <a href="<?php base_url();?>historique"> <button class="btn btn-info pull-rigth mb-2" id="total_envoyer">Total envoyer :  </button> </a>                 
                    </div> 
                    </div>               
                    <br>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 bg-primary">
                            <h6 class="m-0 font-weight-bold text-white">News stock</h6>
                        </div>
                        <div class="card-body">
        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header bg-info">
                    <h5 class="modal-title text-white" id="exampleModalLabel"><i class="fa fa-plus"></i> Adds</h5>
                   ...
                   <div class="container">
                        <form action="" method="post" id="formAjout">                            
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text"  class="form-control" placeholder="0" aria-label="Couleur" aria-describedby="basic-addon1" id="quantite">
                            </div>
                            <div class="input-group mb-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" placeholder="0"  class="form-control"  aria-label="Couleur" aria-describedby="basic-addon1" id="nbPolibague">
                            </div>
                            <div class="input-group mb-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text"  placeholder="0" class="form-control"  aria-label="Couleur" aria-describedby="basic-addon1" id="cpaisage">
                            </div>
                            <div class="input-group mb-3">
                                <span class="input-group-text" id="basic-addon1">Stock</span>
                                <input type="text"  placeholder="0" class="form-control"  aria-label="Couleur" aria-describedby="basic-addon1" id="stock">
                            </div>
                            <div class="input-group mb-3">
                                <span class="input-group-text" id="basic-addon1">Quantité à garder</span>
                                <input type="text"  placeholder="0" class="form-control"  aria-label="Couleur" aria-describedby="basic-addon1" id="agarder">
                            </div>
                            <div class="input-group mb-3">
                                <span class="input-group-text" id="basic-addon1">Allocation</span>
        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header bg-success">
                    <h5 class="modal-title text-white" id="exampleModalLabel"> <i class="fas fa-edit"></i> Edit</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <input type="hidden" id="edit_record_id" name="edit_record_id" value="">                            
                        ...
                        <div class="modal-footer">
                            <button class="btn btn-outline-warning" type="button" data-dismiss="modal">Cancel</button>
                            <button class="btn btn-outline-primary" type="submit" id="update">Edit</button>
                        </div>
                    </form>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" id="transfer_id" name="transfer_id" value="">                            
                            <div class="form-group mb-3"                                <label for="transfer_quantite">Quantité à transferer</label>
